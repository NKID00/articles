...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \begin{sequencediagram}
            ...
            \newinst[0]{wire-input}{信号输入}{}
            \newinst[0]{door-a}{活板门A}{}
            \newinst[0]{wall-a}{石墙A}{}
            \newinst[0]{observer-a}{侦测器A}{}
            \newinst[0]{comparator-a}{比较器A}{}
            \newinst[0]{repeater-a}{中继器A}{}
            \newinst[0]{wire-output}{信号输出}{}
            ...
            \mess[0]{comparator-a}{熄灭}{repeater-a}

            \highlightbegin{comparator-a}

            \mess[0]{repeater-a}{添加计划刻（优先级为-2）}{tile-tick}
            \mess[0]{tile-tick}{执行计划刻}{observer-a}
            ...
            \mess[0]{tile-tick}{执行计划刻}{repeater-a}
            \mess[0]{repeater-a}{解锁}{wire-output}

            \highlightbegin{repeater-a}

            \mess[0]{tile-tick}{执行计划刻}{comparator-a}
            \mess[0]{comparator-a}{激活}{repeater-a}
            ...
            \mess[0]{tile-tick}{执行计划刻}{repeater-a}
            \mess[0]{repeater-a}{锁存}{wire-output}

            \highlightend{repeater-a}
        \end{sequencediagram}
    ...
    \begin{thebibliography}{99}
        \bibitem{bib:wall-based-storage}辰占鳌头. 基于石墙电路的随机存储器[J/OL]. 红石数电评论, 2021, 9.
        ...
        \bibitem{bib:yarn}yarn[CP/OL]. 版本1.17.1+build.61. \url{https://github.com/FabricMC/yarn/actions/runs/1235130702}.
    \end{thebibliography}
