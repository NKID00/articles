...
\fancyhf{}
\lhead{第~一~期\\
\scriptsize{2021~年~9~月}}
\chead{\centering{红~石~数~电~评~论\\
\scriptsize{\textbf{Review of Redstonic Digital Circuit}}}}
\rhead{No. 01\\
\scriptsize{September, 2021}}
\lfoot{}
\cfoot{}
\rfoot{}}
...
\fancyhf{}
\fancyhead[RE]{第~XX~卷}
\fancyhead[CE]{红~石~数~电~评~论}
\fancyhead[LE,RO]{\thepage}
%\fancyhead[CO]{红~石~数~电~评~论}
%\fancyhead[LO]{第~X~期}
\lfoot{}
\cfoot{}
\rfoot{}
